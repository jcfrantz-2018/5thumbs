...
<html>
<div style="text-align: center; border: 5px solid; margin-left: 300px; margin-right: 300px;background-color:green">
    <body onload="checkCookie()">
      ...
      <div class="button-wrapper" style="text-align:center;display:inline-block; margin:10px;">
        <p id='p2' style="padding: 5px; background-color:yellow;color:black;margin-bottom: -10px"><span id='odds1'>20</span>% chance Increase by 2X</p>
        <p id='p3' style="padding: 5px; background-color:yellow;color:black;margin-bottom: -10px"><span id='odds2'>80</span>% chance Decrease to 0.5X</p>
        <button id="apt" onclick="myRisk(); calculate();" style="background-color:red;margin-left:auto;margin-right:auto;display:inline-block;margin-top:22%;margin-bottom:5%; width: 50px">A</button>
      </div>
      ...
      <button onclick="resetProgress()" style="background-color:red;margin-left:auto;margin-right:auto;display:inline-block;margin-top:22%;margin-bottom:0%">Reset Progress</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
      <div class="button-wrapper" style="text-align:center;display:inline-block; margin:10px;">
        <p id='p4' style="padding: 5px; background-color:yellow;color:black;margin-bottom: -10px"><span id='odds3'>30</span>% chance Increase by 1.5X</p>
        <p id='p5' style="padding: 5px; background-color:yellow;color:black;margin-bottom: -10px"><span id='odds4'>70</span>% chance Decrease to 0.75X</p>
        <button id="opt" onclick="mySafe(); calculate();" style="background-color:red;margin-left:auto;margin-right:auto;display:inline-block;margin-top:22%;margin-bottom:5%; width: 50px">B</button>
      </div>
     </body>
